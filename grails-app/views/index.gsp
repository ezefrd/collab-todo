...
<body>
	...
	<p style="margin-left: 20px; width: 80%;">Welcome to CollabTodo
		application. as part of the Apress Book, "Beginning Groovy, Grails and
		Griffon." Functionally, the application is a collaborative "To-Do"
		list that allows users and their buddies to jointly manage "To-Do"
		tasks.</p>
	<br />
	<p style="margin-left: 20px; width: 80%">Building the Collab-Todo
		application is used to walk the user through using Grails 2 to build
